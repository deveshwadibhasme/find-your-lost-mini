...
function App() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post("https://find-your-lost-mini-production.up.railway.app/api/missing", formData);
  ...
  const handleSearch = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.get("https://find-your-lost-mini-production.up.railway.app/api/missing", {
        params: search,
      });
  ...
  const markAsFound = async (id) => {
    try {
      await axios.put(`https://find-your-lost-mini-production.up.railway.app/api/missing/${id}/found`);
